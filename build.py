...
# ----- CONFIGURE THESE -----
SYNC_FOLDERS = [] # folders to be synced, such as Cards, Blueprints, Icons, etc.
COPY_FILES = ["manifest.json", "icon.png", "workshop.txt"] #, "localization.tsv"] # individual files to copy, such as manifest.json, localization.tsv, etc. (the mod dll is copied automatically)
...
p = subprocess.Popen("dotnet build BoardViewKeys.sln", stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
